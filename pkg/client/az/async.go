...
func (wrapper *AsyncDocumentWrapper) sendResponse(ctx context.Context, response DocumentResponse) (e error) {
...
// HTTP requests sent to the Azure AI Language service API.
