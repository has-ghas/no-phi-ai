...
func NewScanner(ctx context.Context, config *cfg.Config, result_io rrr.ResultRecordIO) (*Scanner, error) {
...
func (s *Scanner) processResponse(r rrr.Response, chan_errors_out chan<- error) {
